                        ...
                        <button
                          onClick={() => {
                            if (window.confirm(`Are you sure you want to delete ${emp.name}?`)) {
                              ...
                              showSnackbar(`${emp.name} deleted successfully.`);
                            }
                          }}
                          className="bg-gray-100 text-red-700 px-2 py-1 rounded hover:bg-red-100 flex items-center gap-1 font-semibold shadow"
